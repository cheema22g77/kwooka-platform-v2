...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-cream via-orange-50 to-ochre-100 py-12">
      <div className="max-w-md w-full p-8 bg-white rounded-2xl shadow-xl border border-ochre-100">
        <div className="text-center mb-8">
          ...
          <p className="text-earth-500 mt-1">Create your account</p>
        </div>
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-earth-700 mb-1">Organisation Name</label>
            <input
              type="text"
              value={orgName}
        ...
        <p className="mt-6 text-center text-sm text-earth-500">
          ...
          <Link href="/login" className="text-kwooka-600 hover:text-kwooka-700 font-medium">Sign in</Link>
        </p>
      </div>
    </div>
  )
